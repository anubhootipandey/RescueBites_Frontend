...
const AIRecipeGenerator = () => {
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      const prompt = `You are a professional chef AI assistant. Create a detailed, creative recipe using these leftover ingredients: ${ingredientList.join(', ')}.

Please provide:
1. A creative recipe name
2. List of ingredients needed (including the provided ones and any common pantry items)
3. Step-by-step cooking instructions
4. Estimated cooking time
5. Number of servings
6. Any helpful cooking tips

Make the recipe practical, delicious, and perfect for using up leftovers. Format the response in a clear, easy-to-read manner with proper headings and structure.`;
      ...
      setRecipe(generatedRecipe.trim());
    } catch (err) {
